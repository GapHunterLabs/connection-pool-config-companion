package dev.gaphunter.connectionpoolconfigcompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.connectionpoolconfigcompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.connectionpoolconfigcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Connection Pool Config Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33801-connection-pool-config-companion/reviews"
